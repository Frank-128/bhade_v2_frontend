        ...
        <div className="space-y-5">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <input className="w-full p-2 rounded-0 border-0 text-purple-500 border-b-1 border-gray-400 focus:border-purple-500 focus:ring-0 outline-none placeholder:text-gray-400 focus:placeholder:text-purple-500" placeholder="email" {...field} />
                    </FormControl>
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      ...
                      <input className="outline-none border-none" type={showPassword?"text":"password"}  placeholder="password" {...field} />
              ...
              />
              <Button type="submit" className="w-full bg-purple-500 p-1 text-white cursor-pointer">Signin</Button>
            </form>
          </Form>
        </div>
      </div>
